...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" id="Home" canvaswidth="768" canvasheight="432" orientation="horizontal" controller="HomeController" namespace="com.yonyou.education">
    ...
    <div id="viewPage0">
        ...
        <toolbar id="toolbar0">
            <input imagebuttontype="icontext" id="imagebutton2" value="首页" istogglebutton="true" class="imagebuttonclass" onclick="this.changePage()" type="imagebutton" checked="true"/>
