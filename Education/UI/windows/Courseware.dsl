...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" id="Courseware" canvaswidth="768" canvasheight="432" orientation="horizontal" controller="CoursewareController" namespace="com.yonyou.education">  
    ...
    <div id="viewPage0"> 
        ...
        <toolbar id="toolbar0"> 
            ...
            <input imagebuttontype="icontext" id="imagebutton4" value="课件" istogglebutton="false" class="imagebuttonclass" onclick="this.changePage()" type="imagebutton" checked="true"/>  
